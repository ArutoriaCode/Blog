...
export const LazyArticlesCard = import('../../components/ArticlesCard.vue' /* webpackChunkName: "components/ArticlesCard" */).then(c => c.default || c)
...
export const LazyLeftNavigation = import('../../components/LeftNavigation.vue' /* webpackChunkName: "components/LeftNavigation" */).then(c => c.default || c)
...
export const LazyTopCarousel = import('../../components/TopCarousel.vue' /* webpackChunkName: "components/TopCarousel" */).then(c => c.default || c)
