...
import { EXIST_USER, LOGIN_SUCEESS, PARAMS_ERROR, SUCCESS } from "../config/codes"
...
export default async (_response, ctx) => {
  ...
  console.log("🚀 ~ file: clientHandlerException.js ~ line 45 ~ _response.data", _response.data)
  switch (code) {
    case LOGIN_SUCEESS:
